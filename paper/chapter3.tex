...
\lstinputlisting[language=C, caption=Minimaler Kontrakt für \texttt{equal}]{codes/equal_robust_contract_acsl.c}
...
\lstinputlisting[language=C, caption=Kontrakt für \texttt{strdup} (String duplizieren) in VeriFast]{codes/strdup_contract_verifast.c}
