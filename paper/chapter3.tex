...
in der Spezifikation wiederzufinden, denn das einzelne Definieren von disjunkten Fällen ist in Verifast 
nicht möglich (siehe \ref{sec:design-by-contract:behaviors}). Die Zeile 3 kombiniert daher beide Fälle 
...
Die zwei Fälle sind nun wesentlich besser sichtbar und damit auch verständlicher. Diese Spezifikation ist
subjektiv empfunden daher ein wenig lesbarer, obwohl die Abwägung zwischen Codelänge und Präzision
sicherlich generell schwierig ist.
