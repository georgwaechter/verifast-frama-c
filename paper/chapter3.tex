...
Speicherbereiche disjunkt sind (siehe dazu \ref{sec:theorie:seperation-logic} über die Separierungslogik)\footnote{Die einfache
...
Speicherzugriffsrecht wäre allerdings treffender, da die Prädikate nicht nur den dynamischen Speicher meinen, sondern beliebigen.
...
\lstinputlisting[language=C, caption=Definition des generischen Listentyps (übernommen aus list.gh)]{codes/chapter3/inductive_list_verifast.c}
