...
\todo{seiteneffekte werden unterschiedlich beschrieben, manchmal ist assigns einfacher, z.B. bei der definition von max?}
\todo{ob es seiteneffekte gibt ist bei assigns auch einfacher rauszulesen!}
