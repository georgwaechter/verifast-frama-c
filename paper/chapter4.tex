...
ACSL bekannten Axiome. Richtig dokumentiert ist diese Funktion allerdings nicht, da sie laut der Verifast-Autoren
...
Der Beweis wird als Funktionskörper definiert und von Verifast auf Terminierung überprüft. Dabei muss
\todo{zitat zu tutorial, seite 15}
darauf geachtet werden, dass das Werkzeug die Induktion erkennt. Für die Induktion über eine Liste
ist es beispielsweise notwendig den Beweis mit einer \texttt{switch}-Anweisung zu beginnen. Eine
semantisch äquivalente Form mit \texttt{if}-Anweisungen wird nicht akzeptiert.
\begin{figure}[H]
...
Datei, damit das Werkzeug nicht bei jeder Verifizierung alle diese überprüfen muss.
