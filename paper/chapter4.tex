...
geht es nun um die Verifizierung der Implementierungen.
...
ist auch für den Leser schnell ersichtlich, dass Nachbedingung direkt aus der Invariante folgt.
...
ist in VeriFast nicht einsehbar an welchen Stellen eine Prüfung stattfindet. Frama-C ist in diesem Fall
